...
const gameData = {
    ...
    function updateGame() {
        ...
        // If this is a result node (assuming result nodes have IDs starting with "result-")
        if (currentNode.startsWith("result-")) {
            console.log("Result node reached:", node);
            // Hide the game content and show the results page
            document.getElementById("game-container").style.display = "none";
            document.getElementById("results-page").style.display = "block";
            
            // Get the result animal, if provided
            let resultAnimal = node.resultAnimal ?  node.resultAnimal : "Unknown";
            // Format the results text to include the animal/persona
            document.getElementById("results-text").innerHTML =
                `<strong>You are a ${resultAnimal}!</strong>`;
            return; // exit updateGame so no choices are rendered
        }

    
        // For other nodes, ensure the game container is visible and hide results
        document.getElementById("game-container").style.display = "block";
        document.getElementById("results-page").style.display = "none";
        
        // Update question counter and story text
        ...
        // Reset button event (remains as before)
        ...
        // Add choice buttons for current node
